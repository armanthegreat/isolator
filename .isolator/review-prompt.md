...
4. **Apply project standards**: Follow the established coding standards in the project at @.isolator/CODING_STANDARDS.md.
...
2. Run `pnpm run typecheck` and `pnpm run test` to ensure nothing is broken
