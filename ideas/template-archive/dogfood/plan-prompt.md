...
For each unblocked issue, assign a branch name using the format `isolator/issue-{number}-{slug}`.
...
<plan>
{"issues": [{"number": 42, "title": "Fix auth bug", "branch": "isolator/issue-42-fix-auth-bug"}]}
</plan>
