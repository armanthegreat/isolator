...
import { buildRecoveryMessage } from "./RecoveryMessage.ts";

describe("buildRecoveryMessage", () => {
  const patchDir = ".isolator/patches/20260324-153000";
  ...
  describe("--branch recovery commands", () => {
    ...
    it("git am failure includes worktree setup", () => {
      ...
      expect(msg).toContain("git worktree add .isolator/worktree feature/test");
      expect(msg).toContain("cd .isolator/worktree");
      expect(msg).toContain("git am --continue");
    });
